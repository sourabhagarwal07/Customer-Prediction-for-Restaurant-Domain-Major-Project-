...
public final class valparking_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Class.forName("oracle.jdbc.driver.OracleDriver");
    ...
    ResultSet resultSet = stmt.executeQuery("SELECT COUNT(parking_lot), parking_lot FROM userfeed GROUP BY parking_lot ORDER BY COUNT(parking_lot) DESC");
