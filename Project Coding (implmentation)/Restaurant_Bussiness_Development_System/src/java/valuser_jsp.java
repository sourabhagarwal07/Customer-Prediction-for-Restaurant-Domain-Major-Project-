...
public final class valuser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<b><A href=\"self.jsp\">Click Here</a> to find detail FEEDBACK from USERID.</b>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
 ...
 Class.forName("oracle.jdbc.driver.OracleDriver");
    ...
    ResultSet resultSet = stmt.executeQuery("SELECT COUNT(yn), userid FROM userfeed GROUP BY userid ORDER BY COUNT(yn) DESC");
	...
	//if(!resultSet.next()) {
      ...
      out.write("            <TR>\r\n");
      out.write("               <TH>Total Arrivals</TH>\r\n");
