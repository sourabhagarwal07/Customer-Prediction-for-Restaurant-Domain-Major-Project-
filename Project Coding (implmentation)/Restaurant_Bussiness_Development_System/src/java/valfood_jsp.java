...
public final class valfood_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Class.forName("oracle.jdbc.driver.OracleDriver");
    ...
    ResultSet resultSet = stmt.executeQuery("SELECT COUNT(userid), FOOD_TYPE FROM userfeed GROUP BY FOOD_TYPE ORDER BY COUNT(userid) DESC");
